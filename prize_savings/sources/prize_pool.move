...
public fun is_winner<T>(self: &PrizePool<T>, user_address: address, tier: u64, prize_index: u64): bool {
  ...
  assert!(twab_controller_snapshot.twab_by_users().contains(&user_address), ENotEligible);
